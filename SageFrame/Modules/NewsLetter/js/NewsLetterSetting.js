$(function() {
    ...
    var nlSetting = {
        ...
        SaveNLSetting: function() {
            ...
            var param = JSON2.stringify({ SettingKey: settingKey, SettingValue: settingValue, UserModuleID: nlSetting.config.UserModuleID, PortalID: nlSetting.config.PortalID });
            $.ajax({
                type: "POST",
        ...
        GetSetting: function() {
            var param = JSON2.stringify({ UserModuleID: nlSetting.config.UserModuleID, PortalID: nlSetting.config.PortalID });
            $.ajax({
                type: "POST",
    ...
    nlSetting.init();
    $("#btnSaveNLSetting").die().live("click", function() {
