            ...
            <div class="sfCollapsewrapper">
                ...
                <div id="tblSite" runat="server" class="sfCollapsecontent">
                    ...
                    <div class="sfFormwrapper">
                        ...
                        <asp:Label ID="lblMetaHelpText" runat="server" CssClass="sfNote" meta:resourcekey="lblMetaHelpTextResource1">These Meta information is for the default value of page meta tags, if site administrator will leave any of these meta tags while adding and updating a pages then these meta information will be ovewritten for that meta value for a page.</asp:Label>
                    </div>
                </div>
            </div>
            <div class="sfCollapsewrapper">
                    ...
                    <div class="sfFormwrapper">
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:Button ID="btnRefreshCache" runat="server" CssClass="sfBtn" Text="Refresh" OnClick="btnRefreshCache_Click"
