    ...
    <div id="tabDashboard" class="cssClassTabpanelContent">
        ...
        <div id="dvQuickLinks" class="sfDashboardpanel">
            <div class="sfTabLeftDiv">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="sfButtonwrapper sftype1 sfMarginnone">
                                        <label class="sfAdd" id="btnAddQuickLink">
                                            Add QuickLink Item</label>
                                        <label class="sfCancel" id="btnCancelQuickLink" style="display: none">
                                            Cancel</label>
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="sfButtonwrapper sftype1">
                    <label class="sfSave" id="btnSaveQuickLinkOrder">
                        Save Item Order</label>
                    <div class="clear">
                    </div>
                </div>
            </div>
        ...
        <div id="dvSidebar" class="cssClassTabPabelTabel">
            <div class="sfTabLeftDiv">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="sfButtonwrapper sftype1 clearfix sfMarginnone">
                                        <label class="sfAdd float-right" id="btnAddSidebar">
                                            Add Sidebar Item</label>
                                        <label class="sfDelete float-right" id="btnCancelSidebar">
                                            Cancel</label>
                                    </div>
                                </td>
                            </tr>
                ...
                <div class="sfButtonwrapper sftype1">
                    <label class="sfSave" id="btnSaveSidebarOrder">
                        Save Item Order</label>
                    <div class="clear">
                    </div>
                </div>
